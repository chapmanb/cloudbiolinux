...
def install_bowtie(env):
    ...
    """
    version = env.get("tool_version", "0.12.7")
...
def install_bwa(env):
    ...
    """
    version = env.get("tool_version", "0.5.9")
...
def install_bfast(env):
    ...
    """
    version = env.get("tool_version", "0.7.0a")
...
def install_samtools(env):
    ...
    """
    version = env.get("tool_version", "0.1.18")
...
def install_fastx_toolkit(env):
    ...
    """
    version = env.get("tool_version", "0.0.13")
    gtext_version = "0.6"
...
def install_tophat(env):
    ...
    _install_boost(env)
    version = env.get("tool_version", "2.0.0")
...
def install_abyss(env):
    ...
    version = env.get("tool_version", "1.3.3")
...
def install_velvet(env):
    ...
    """
    version = env.get("tool_version", "1.2.05")
...
def install_macs(env):
    ...
    """
    version = env.get("tool_version", "1.4.2")
