...
ENV_PY_VERSIONS = collections.defaultdict(lambda: "python=3.7")
ENV_PY_VERSIONS[None] = "python=3.7"
ENV_PY_VERSIONS["python2"] = "python=2"
ENV_PY_VERSIONS["python3"] = "python=3.7"
ENV_PY_VERSIONS["dv"] = "python=3.7"
...
def _create_environments(conda_bin, packages):
    ...
    for addenv in ["python3", "samtools0", "dv", "python2", "r36", "htslib1.10"]:
